...
public sealed class TeamRepository : ITeamRepository 
{
    ...
    public async Task<Team> CreateAsync(Team entity, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Team?> UpdateAsync(int id, Team entity, CancellationToken cancellationToken = default)
    {
