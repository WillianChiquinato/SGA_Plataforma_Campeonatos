...
public sealed class StatusRepository : IStatusRepository 
{
    ...
    public async Task<Status> CreateAsync(Status entity, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Status?> UpdateAsync(int id, Status entity, CancellationToken cancellationToken = default)
    {
