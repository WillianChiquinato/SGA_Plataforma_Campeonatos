...
public sealed class RoundRepository : IRoundRepository 
{
    ...
    private readonly DbSet<Round> _dbSet;

    public RoundRepository(AppDbContext context)
    {
        _context = context;
        _dbSet = _context.Set<Round>();
    }
    ...
    public async Task<Round> CreateAsync(Round entity, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<Round?> UpdateAsync(int id, Round entity, CancellationToken cancellationToken = default)
    {
